...
11. **The answer comes before the inputs.** The recommendation is the first thing on the page, and a sticky line carries it down while the figures behind it are being edited. A decision tool that makes you scroll past four forms to reach the decision is a form, not a tool.
